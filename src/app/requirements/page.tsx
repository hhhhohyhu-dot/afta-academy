        ...
        >
          <ul className="space-y-6 text-slate-700 text-lg">
            ...
            <li className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-900 mb-1">{isAr ? "اللغات" : "Languages"}</h3>
                <p className="text-slate-600 text-base">{isAr ? "مستوى تواصل جيد في اللغتين الفرنسية والإنجليزية." : "Good communication skills in French and English."}</p>
              </div>
            </li>
